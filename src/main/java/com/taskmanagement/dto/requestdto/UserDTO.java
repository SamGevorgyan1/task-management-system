...
public class UserDTO {
    ...
    public static final String NAME_REGEX_MSG = "Name must start with uppercase and contain min 3 characters";
    ...
    public static final String SURNAME_REGEX_MSG = "Surname must start with uppercase and contain min 3 characters";
